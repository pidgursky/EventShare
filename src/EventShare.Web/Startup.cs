...
namespace EventShare.Web
{
    public class Startup
    {
        ...
        private async Task PrepareRolesAndUsers(IServiceProvider serviceProvider)
        {
            ...
            var administratorEmail = Configuration.GetSection("UserSettings")["UserEmail"];
            ...
            if (administrator == null)
            {
                ...
                {
                    await userManager.AddToRoleAsync(administrator, Roles.Admin);
                }
            }
        }
    }
